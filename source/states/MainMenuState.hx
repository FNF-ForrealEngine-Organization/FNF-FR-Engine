...
class MainMenuState extends MusicBeatState
{
	...
	public static var forrealEngineVersion:String = '0.3.0';
	...
	override function create()
	{
		...
		if (showOutdatedWarning && ClientPrefs.data.checkForUpdates && substates.OutdatedSubState.updateVersion != forrealEngineVersion) {
